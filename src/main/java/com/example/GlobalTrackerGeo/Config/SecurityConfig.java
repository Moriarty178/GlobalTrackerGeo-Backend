    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/**", "/images/**","/trips/**", "/payments/**")// (tránh lỗi 403 :forbidden) chỉ định các đường dẫn th này là: tất cả URL bắt đầu với /public/. Kí tự ** là đường dẫn con, phần sau (sub-path): dùng cho các tài nguyên công cộng như: trang giới thiệu, hoặc các API ko cần bảo mật
